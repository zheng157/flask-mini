...
class PayServce2():
    ...
    def createOrder2(self,member_id,items = None,params = None):
    ...
    def orderSuccess2(self,pay_order_id = 0 ,params = None):
        try:
    ...
    # 写进回调记录表
    def addPayCallbackData2(self,pay_order_id = 0,type = 'pay',data = ''):
